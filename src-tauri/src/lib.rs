...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::lagre_plan,
            commands::hent_periode_for_uke,
            commands::sjekk_periode_kollisjon,
            commands::opprett_periode,
            commands::endre_periode,
            commands::koble_fra_periode,
            commands::los_uke_fra_periode,
            commands::propager_til_periode,
            pdf_export::lagre_forhandsvisning_som_pdf,
            pdf_export::vis_pdf_i_utforsker,
            pdf_export::apne_pdf_fil,
        ])
